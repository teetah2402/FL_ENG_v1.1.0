...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\routes\filesystem_routes\__init__.py total lines 53 
...
class FilesystemRoutes(BaseApiRoute):
    ...
    def handle_list_drives(self, *args, **kwargs):
        return self.execute_sync('handle_list_drives', *args, **kwargs)
    def handle_list_directory(self, *args, **kwargs):
        return self.execute_sync('handle_list_directory', *args, **kwargs)
