...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\base_api_route\__init__.py total lines 51 
...
class BaseApiRoute(ABC):
    ...
    def _json_response(self, *args, **kwargs):
        return self.execute_sync('_json_response', *args, **kwargs)
