...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\settings_routes\__init__.py total lines 46 
...
class SettingsRoutes(BaseApiRoute):
    ...
    async def handle_get_settings(self, *args, **kwargs):
        return await self.execute_async('handle_get_settings', *args, **kwargs)
    async def handle_patch_settings(self, *args, **kwargs):
        return await self.execute_async('handle_patch_settings', *args, **kwargs)
