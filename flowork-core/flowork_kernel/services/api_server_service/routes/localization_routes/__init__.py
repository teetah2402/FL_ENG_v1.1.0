...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\localization_routes\__init__.py total lines 44 
...
class LocalizationRoutes(BaseApiRoute):
    ...
    async def handle_get_dictionary(self, *args, **kwargs):
        return await self.execute_async('handle_get_dictionary', *args, **kwargs)
