...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\agent_routes\handle_stop_agent_run.py total lines 22 
...
async def run(hub, request):
    ...
    if 'error' in result:
        return await hub.execute_async('_json_response', result, status=404)
    else:
