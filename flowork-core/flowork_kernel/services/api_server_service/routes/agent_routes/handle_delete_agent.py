...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\agent_routes\handle_delete_agent.py total lines 21 
...
async def run(hub, request):
    ...
    if agent_manager.delete_agent(agent_id):
        ...
        return await hub.execute_async('_json_response', {'error': 'Agent not found.'}, status=404)
