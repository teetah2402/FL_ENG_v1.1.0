...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\auth_routes\__init__.py total lines 56 
...
class AuthRoutes(BaseApiRoute):
    ...
    def _extract_token_from_header(self, *args, **kwargs):
        return self.execute_sync('_extract_token_from_header', *args, **kwargs)
    async def handle_register(self, *args, **kwargs):
        return await self.execute_async('handle_register', *args, **kwargs)
    async def handle_login(self, *args, **kwargs):
        return await self.execute_async('handle_login', *args, **kwargs)
    async def handle_logout(self, *args, **kwargs):
        return await self.execute_async('handle_logout', *args, **kwargs)
    async def handle_get_profile(self, *args, **kwargs):
        return await self.execute_async('handle_get_profile', *args, **kwargs)
