...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\filesystem_routes\__init__.py total lines 56 
...
class FilesystemRoutes(BaseApiRoute):
    ...
    def _get_safe_roots(self, *args, **kwargs):
        return self.execute_sync('_get_safe_roots', *args, **kwargs)
    async def handle_list_drives(self, *args, **kwargs):
        return await self.execute_async('handle_list_drives', *args, **kwargs)
    async def handle_list_directory(self, *args, **kwargs):
        return await self.execute_async('handle_list_directory', *args, **kwargs)
    async def handle_view_file(self, *args, **kwargs):
        return await self.execute_async('handle_view_file', *args, **kwargs)
