...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\ui_state_routes\get_dashboard_state.py total lines 18 
...
async def run(hub, request):
    ...
    return await hub.execute_async('_json_response', state or {})
