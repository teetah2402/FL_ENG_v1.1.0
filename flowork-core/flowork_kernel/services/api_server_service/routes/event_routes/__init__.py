...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\routes\event_routes\__init__.py total lines 44 
...
class EventRoutes(BaseApiRoute):
    ...
    async def handle_publish_event(self, *args, **kwargs):
        return await self.execute_async('handle_publish_event', *args, **kwargs)
