...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\api_server_service\__init__.py total lines 95
########################################################################
...
class ApiServerService(BaseService):
    ...
    # [Fase 2] Pola Universal Endpoint: Menangkap rute service buatan App [cite: 59, 67]
    async def dynamic_service_gateway(self, request):
        ...
        # Panggil Muscle (AppRuntime) untuk menelepon App Runner [cite: 79]
