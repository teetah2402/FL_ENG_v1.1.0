...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\app_runtime_service\__init__.py
########################################################################
...
class AppRuntimeService(BaseService):
    ...
    async def execute(self, cell_name, *args, **kwargs):
        ...
        # FIX: Gunakan .run sesuai standar DCD
    ...
    # [Fase 3] Immortal Bridge: Panggil aksi spesifik di App Runner
    ...
    # Tambahan Baru: Mendukung App-Builder untuk menulis Atomic Cell ke aplikasi target
