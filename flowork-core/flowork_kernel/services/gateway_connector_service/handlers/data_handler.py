...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\gateway_connector_service\handlers\data_handler.py total lines 400 
########################################################################
...
class DataHandler(BaseHandler):
    ...
    def register_events(self):
        ...
        async def request_prompts_list(data):
            ...
            error_msg = None
            try:
                prompt_manager = self._get_app_instance("prompt_manager") # [GEMINI ADDED] Skeleton Hybrid Call
        ...
        async def request_datasets_list(data):
            ...
            error_msg = None
            try:
                dataset_manager = self._get_app_instance("dataset_manager") # [GEMINI ADDED] Skeleton Hybrid Call
