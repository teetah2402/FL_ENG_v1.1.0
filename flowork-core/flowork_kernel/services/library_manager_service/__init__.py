...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\library_manager_service\__init__.py
...
class LibraryManagerService(BaseService):
    def __init__(self, kernel, service_id: str):
        ...
        # [Fase 1] Immutability: Folder pusat library [cite: 4, 8]
    ...
    # [NEW] Helper internal untuk install package ke folder Warehouse spesifik
