...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\library_manager_service\start.py total lines 32
...
def run(hub):
    ...
    # Setup Warehouse Path secara global di hub
