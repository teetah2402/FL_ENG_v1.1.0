...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\permission_manager_service\__init__.py total lines 47 
...
class PermissionManagerService(BaseService):
    ...
    def check_permission(self, *args, **kwargs):
        return self.execute_sync('check_permission', *args, **kwargs)
    def request_approval(self, *args, **kwargs):
        return self.execute_sync('request_approval', *args, **kwargs)
