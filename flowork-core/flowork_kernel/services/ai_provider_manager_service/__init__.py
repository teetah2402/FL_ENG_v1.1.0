...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\ai_provider_manager_service\__init__.py
########################################################################
...
class AIProviderManagerService(BaseService):
    ...
    def __init__(self, kernel, service_id: str):
        ...
        # [cite_start]Penentuan path provider dan model [cite: 97]
        ...
        # [cite_start]Setup direktori kerja [cite: 99]
    ...
    def run(self, data: dict):
        ...
        if action == 'generate':
            # [cite_start]Meneruskan ke query_ai_by_task sesuai struktur LazyHub [cite: 107]
    ...
    def _load_cell(self, cell_name):
        if cell_name not in self.cells:
            try:
                # [cite_start]Memastikan import module dari package yang benar [cite: 102]
    ...
    # [cite_start]--- PROXY METHODS (DCD MAPPING) [cite: 104-108] ---
