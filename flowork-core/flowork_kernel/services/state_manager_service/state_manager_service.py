...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\state_manager_service\state_manager_service.py total lines 108 
########################################################################
...
class StateManagerService(BaseService):
    ...
    def _load_global_state(self):
        try:
            ...
            else: self._global_state_cache = {}
        except: self._global_state_cache = {}
    ...
    def update_all(self, data: dict, user_id: str = None): pass
    def delete(self, key, user_id: str = None): pass
    def get_all(self, user_id: str = None): return {}
