...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\services\database_service\_run_migration_v9.py
...
def run(hub, cursor):
    ...
    # Tabel untuk menyimpan teks mentah dan metadata
    cursor.execute('''
    ...
    # Tabel untuk menyimpan koordinat vektor (Embedding)
    # Kita simpan sebagai TEXT (JSON) agar kompatibel dengan SQLite standar di Docker/WSL
    cursor.execute('''
