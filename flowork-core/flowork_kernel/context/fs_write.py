...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\context\fs_write.py total lines 72 
...
def run(hub, file_path: str, content: str):
    hub.execute_sync('_enforce_permission', 'fs_write', file_path, 'fs_write')
    ...
    try:
        ...
        hub.execute_sync('_enforce_gas', gas_cost, 'fs_write')
        ...
        hub.timeline.log('fs_write', log_data)
