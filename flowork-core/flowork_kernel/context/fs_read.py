...
# File NAME : C:\FLOWORK\flowork-core\flowork_kernel\context\fs_read.py total lines 77 
...
def run(hub, file_path: str) -> str:
    hub.execute_sync('_enforce_permission', 'fs_read', file_path, 'fs_read')
    ...
    try:
        ...
        hub.execute_sync('_enforce_gas', gas_cost, 'fs_read')
        ...
        hub.timeline.log('fs_read', log_data)
