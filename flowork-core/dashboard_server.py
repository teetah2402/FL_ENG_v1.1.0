...
# File NAME : C:\flowork-nano\flowork-core\dashboard_server.py total lines 313 
########################################################################
...
def run_dashboard_server(kernel_instance, host="0.0.0.0", port=5001):
        ...
        return jsonify(
            {
                ...
                "license_tier": "OPEN_CORE_WEB3", # HARDCODED: Web3 Architecture
    ...
    def get_status():
        components = {}
        managers = {
            "Apps": kernel_instance.get_service("app_manager_service"), # KEEPALIVE: Core App Manager
        }
